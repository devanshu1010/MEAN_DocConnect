...
export class DoctorConsultingComponent implements  OnInit,OnDestroy  {
  ...
  constructor( public doctorServ: DoctorService, private firebaseService: FirebaseserviceService , private datePipe: DatePipe,private firestore: AngularFirestore,private router: Router, private aroute: ActivatedRoute ) { }
